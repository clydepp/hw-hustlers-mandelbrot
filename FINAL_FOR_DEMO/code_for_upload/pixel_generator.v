...
localparam FRAC = 28;
localparam DEPTH_WIDTH = 13;
// localparam ZOOM = 0;
// localparam ZOOM_RECIPROCAL = 32'd1<<(FRAC - 1); // Reciprocal of zoom in Q-format
// localparam [WORD_LENGTH-1:0] REAL_CENTER = 0;
// localparam [WORD_LENGTH-1:0] IMAG_CENTER = 0;
// localparam [15:0] MAX_ITER_RECIPROCAL = (MAX_ITER != 0)
//       ? ( (32'd1 << 16) / MAX_ITER )
//        : {16{1'b0}};
// localparam JULIA = 0;  
// localparam [31:0] JULIA_IM = 2 <<< FRAC-3;
// localparam [31:0] JULIA_RE = 2 <<< FRAC-3;
 ...
 wire JULIA = regfile[5]; 
 wire [31:0] JULIA_RE = regfile[6];
 wire [31:0] JULIA_IM = regfile[7];
...
wire data_avail;
wire [DEPTH_WIDTH-1:0] final_depth; // Final depth to be used for color mapping
initial begin
    ...
    regfile[2] = 32'd0; // Example: ZOOM = 1.0
